                ...
                <!-- Search -->
                    <div class="d-flex align-items-center flex-grow-1" style="min-width: 0;">
                        ...
                        <h5 class="mb-0" style="min-width: 0;">
                                <span class="d-inline d-md-none fw-semibold small text-truncate d-inline-block" style="max-width: 100%;">Dashboard Admin {{ session('tahun') }}</span>
                            <span class="d-none d-md-inline fw-semibold">Dashboard Admin Tahun {{ session('tahun') }}</span>
                        </h5>
                    </div>
                </div>
                <!-- /Search -->
                                ...
                                <a class="dropdown-item" href="javascript:void(0);">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            <span class="fw-medium d-block">Syahrir Lubis</span>
