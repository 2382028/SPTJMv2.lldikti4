...
<head>
    <meta charset="utf-8">
    <title>SPT 1721-VI (NON PNS)</title>
    <style>
...
<body>
    <div class="text-center">
        ...
        <div class="small">BAGI PEGAWAI TETAP ATAU PENERIMA PENSIUN ATAU TUNJANGAN HARI TUA/JAMINAN HARI TUA BERKALA</div>
        <div class="mt-8"><strong>FORMULIR 1721 - VI</strong></div>
    </div>
    ...
    <div class="mt-12 box">
        ...
        <table class="table mt-8">
            ...
            <tr>
                ...
                <td class="value">{{ $transaksi->nik ?? $transaksi->NIK ?? '-' }}</td>
            </tr>
            <tr>
