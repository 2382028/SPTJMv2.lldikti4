        ...
        <div class="card-body">
            ...
            <div class="demo-inline-spacing">
                <div class="d-flex justify-content-center">
                    <a href="{{ route('dosen.dashboard') }}" class="btn btn-secondary mx-2" onclick="event.preventDefault(); if (history.length > 1) { history.back(); } else { window.location.href = this.href; }">Kembali</a>
                </div>
            </div>
        </div>
    </div>
