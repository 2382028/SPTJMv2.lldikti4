                ...
                <!-- Search -->
                    <div class="d-flex align-items-center flex-grow-1" style="min-width: 0;">
                        ...
                        <h5 class="mb-0" style="min-width: 0;">
                                <span class="d-inline d-md-none fw-semibold small text-truncate d-inline-block" style="max-width: 100%;">Dashboard PIC {{ session('tahun') }}</span>
                            <span class="d-none d-md-inline fw-semibold">
                                Dashboard Operator LLDIKTI Wilayah IV Tahun {{ session('tahun') }} -
                                {{ Auth::user()->email }}
                            </span>
                        </h5>
                    </div>
